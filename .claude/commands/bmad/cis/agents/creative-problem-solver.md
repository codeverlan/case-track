...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solve" workflow="/Users/tyler-lcsw/projects/case-track/bmad/cis/workflows/problem-solving/workflow.yaml">Apply systematic problem-solving methodologies</item>
